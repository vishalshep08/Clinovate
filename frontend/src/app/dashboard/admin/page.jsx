...
// import { Users, FileText, ClipboardList, GraduationCap, LogOut } from "lucide-react";
...
//       {/* Sidebar */}
//       <aside className="w-64 bg-[#004D40] text-white flex flex-col shadow-2xl">
...
//                     : "text-gray-100 hover:bg-[#26A69A]/60 hover:text-white"
//                 }`}
//               >
...
//           <button
//             onClick={onLogout}
//             className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold mt-8 bg-red-600 hover:bg-red-500 text-white transition"
//           >
...
//         <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-xl border border-gray-200 p-6 transition-all">
//           {activeTab === "requests" && (
...
//           {activeTab === "students" && (
//             <div>
//               <h2 className="text-2xl font-bold text-[#004D40] mb-6 flex items-center gap-2">
...
//                   <table className="min-w-full border-collapse border border-gray-200 text-left text-sm rounded-xl overflow-hidden">
//                     <thead>
...
//                         >
//                           <td className="p-3 text-gray-700">{stu.id}</td>
//                           <td className="p-3 text-gray-700">{stu.name}</td>
//                           <td className="p-3 text-gray-700">{stu.email}</td>
        ...
        <nav className="flex flex-col gap-2 p-4">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <Icon className={`w-5 h-5 ${isActive ? "text-[#004D40]" : ""}`} />
                {tab.label}
              </button>
            );
          })}
